...
<!-- mdBook uses multiple H1 headings for "parts" in the table of contents -->
# Summary

[Onshape MCP](project/index.md)
...
- [MCP Tools](project/mcp-tools.md)
- [Configuration](project/configuration.md)
- [Authentication](project/authentication.md)
- [Error Handling](project/error-handling.md)
- [Tracing](project/tracing.md)
